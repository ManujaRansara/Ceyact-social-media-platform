        ...
        <span style="font-weight:bold;font-size:30px;display:block;">
          place where it all connects
                   ...
                   <a  href="welcome.php" style="text-decoration: none;">
                    ...
                    <span style="color:rgb(11, 66, 129);font-weight:bold;font-family:tahoma;" style="text-decoration: none;">Creator</span>
                    </div></a>
      <div id="b"> 
        ...
        <div id="b1">
          This idea and its implementation were developed by Manuja Ransara Hapuarachchi, who is currently an undergraduate, studying computer science at the University of Colombo.<br>
          Current Owner : H.Manuja Ransara
        </div>
        <div id="b2">
